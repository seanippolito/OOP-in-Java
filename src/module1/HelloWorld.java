...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map3 = new UnfoldingMap(this, 850, 50, 350, 500, provider2);
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.8477098f, -117.2770681f));
	    
	    map2.zoomAndPanTo(zoomLevel, new Location(40.136719f, -74.2351907f));
	    
	    map3.zoomAndPanTo(zoomLevel, new Location(-22.9068f, -43.1729f));
